                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Ask me about cybersecurity and cyber regulation</h1>
                            <h4 className={styles.chatEmptyStateSubtitle}>I know NIST 800-123/82, 800-82, EBM hardening, EU CRA, Colorado AI Act, and some SE products </h4>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. what are the security topics covered in the NIST hardening standard?)"
                            disabled={isLoading}
