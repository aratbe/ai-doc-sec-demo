...
class RetrieveThenReadVisionApproach(Approach):
    ...
    system_chat_template_gpt4v = (
        "You are a cybersecurity expert helping users their cybersecurity questions and their product cybersecurity guidelines, The documents contain text, graphs, tables and images. "
